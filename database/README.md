...
API on Drizzle ORM and SQLite. It needs no database server — the default connection is in-memory.
...
| `src/tasks/`         | A module, a controller with the CRUD routes, and a repository. |
