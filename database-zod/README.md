...
API on Drizzle ORM and SQLite. Request bodies are checked by zod, and it needs no database server to
start.
...
| `src/tasks/`         | A module, a controller with the CRUD routes, a repository, and a zod schema. |
